...
if ($lazyLoad) {
    return $this->services['knp_paginator'] = $this->createProxy('Paginator_0795c9b', function () {
        return \Paginator_0795c9b::staticProxyConstructor(function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) {
