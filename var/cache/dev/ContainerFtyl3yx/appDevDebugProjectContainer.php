...
protected function createProxy($class, \Closure $factory)
{
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('qcCXvYM6Av', 0, 'uGFcug-pySTRYJYW1yDBSU', ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('z90W-KodpF', 0, 'uGFcug-pySTRYJYW1yDBSU', ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('k+5Q3I-rjF', 0, 'uGFcug-pySTRYJYW1yDBSU', ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_host' => 'db752531786.db.1and1.com',
            'database_port' => 3306,
            'database_name' => 'db752531786',
            'database_user' => 'dbo752531786',
            'database_password' => 'Streetking5',
            'mailer_transport' => 'smtp',
            'mailer_encryption' => 'ssl',
            'mailer_host' => 'auth.smtp.1and1.fr',
            'mailer_user' => 'service@lafraicheurdes4saisons.fr',
            'mailer_password' => 'Streetking5',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'service@lafraicheurdes4saisons.fr',
            'swiftmailer.mailer.default.transport.smtp.password' => 'Streetking5',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'service@lafraicheurdes4saisons.fr' => 'service@lafraicheurdes4saisons.fr',
            ),
