...
class ProduitsAdminController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('EcommerceEcommerceBundle:Administration:produits/layout/index.html.twig', array(
            'produits' => $produits,
        ));
    }
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('EcommerceEcommerceBundle:Administration:produits/layout/new.html.twig', array(
            'produit' => $produit,
    ...
    public function showAction(Produits $produit)
    {
        ...
        return $this->render('EcommerceEcommerceBundle:Administration:produits/layout/show.html.twig', array(
            'produit' => $produit,
...
//            return $this->redirectToRoute('adminProduits_edit', array('id' => $produit->getId()));
        ...
        return $this->render('EcommerceEcommerceBundle:Administration:produits/layout/edit.html.twig', array(
            'produit' => $produit,
