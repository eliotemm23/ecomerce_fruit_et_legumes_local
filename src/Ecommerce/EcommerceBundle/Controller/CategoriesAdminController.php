...
class CategoriesAdminController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('EcommerceEcommerceBundle:Administration:categories/layout/index.html.twig', array(
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('EcommerceEcommerceBundle:Administration:categories/layout/new.html.twig', array(
            'category' => $category,
    ...
    public function showAction(Categories $category)
    {
        ...
        return $this->render('EcommerceEcommerceBundle:Administration:categories/layout/show.html.twig', array(
            'category' => $category,
    ...
    public function editAction(Request $request, Categories $category)
    {
        ...
        return $this->render('EcommerceEcommerceBundle:Administration:categories/layout/edit.html.twig', array(
            'category' => $category,
