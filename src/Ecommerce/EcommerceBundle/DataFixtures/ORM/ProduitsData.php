...
class ProduitsData extends AbstractFixture implements OrderedFixtureInterface
{
    public function load(ObjectManager $manager)
    {
        ...
        $produit1->setOrigineadr('KEFIR DES WEPPES HALLENNES LEZ HAUBOURDIN 59320 26 place de l\'église');
        ...
        $produit2->setOrigineadr('Marais (EARL du) Wattignies 59139 69 Rue Sadi Carnot');
        ...
        $produit3->setOrigineadr('Gaec des 40 Maisons Lesquin 59810 Rue Georges Basquin');
        ...
        $produit4->setOrigineadr('Choquel Fleuriste Villeneuve-d\'Ascq59650 1 Rue Faidherbe');
        ...
        $produit5->setOrigineadr('Pleurette Lomme 59000 MIN Lomme France');
        ...
        $produit6->setOrigineadr('les mûres ont des abeilles St-André-lez-Lille 59350 2 rue Félix Faure');
